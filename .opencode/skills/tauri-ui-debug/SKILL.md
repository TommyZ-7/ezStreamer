---
name: Tauri UI Debug
description: Diagnose ezStreamer frontend failures (blank window, missing preview frames). Use when the Tauri window misbehaves on any platform.
---
...
- Verify: `cargo check -p ezstreamer` regenerates
